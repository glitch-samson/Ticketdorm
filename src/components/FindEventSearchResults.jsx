...
const FindEventSearchResults = props => {
    const { allEvents, setDisplayedElement } = useContext(AppContext);
        ...
        <div className="px-[1.6rem] lg:px-[8.8rem] font-inter">
            ...
            <section className="py-[0.3rem] flex flex-wrap gap-[1rem] lg:gap-[2rem] *:w-[calc(50%-0.5rem)] lg:*:w-[calc(25%-1.5rem)]">
                ...
                <section className="text-center font-med center font-montserrat flex-[0_0_100%]">
                    <section className={props.defaultSearchBar ? "h-[70vh] center" : null}>
                        <section>
                            ...
                            <Link to="/sell-tickets" onClick={() => setDisplayedElement(false)}><button className="p-[1rem] rounded-[12px] text-white bg-[#0E4887]">Create Event</button></Link>
                        </section>
                    </section>
                </section>
                }
